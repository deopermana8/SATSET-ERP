...
export default function ReservationPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const reservationId = new ReservationId(String(Date.now() + Math.floor(Math.random() * 9999)));
    ...
    return (<main style={{ padding: 24 }}>
      ...
      {status && (<div style={{ marginTop: 16 }}>
          <strong>Status:</strong> {status}
        </div>)}

      {quotation && (<section style={{
                marginTop: 20,
                padding: 12,
          ...
          <div>
            ...
            <ul>
              {quotation.lineItems.map((item, idx) => (<li key={idx}>
