...
const OUTPUT_DIR = path.resolve(process.cwd(), "generated", "hris");

async function main(): Promise<void> {
  console.log("Generating HRIS...");
  const report = await runFullPipeline(
    "Create HRIS with employee department position attendance leave payroll recruitment dashboard reports authentication",
    OUTPUT_DIR
  );
  ...
  console.log("HRIS GENERATION PASS");
}
