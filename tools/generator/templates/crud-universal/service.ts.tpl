import { {{names.entity.pascal}}Repository } from "./{{names.entity.pascal}}Repository";

export class {{names.entity.pascal}}Service {
  constructor(private readonly repository: {{names.entity.pascal}}Repository) {}
